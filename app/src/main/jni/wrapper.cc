...
static jlongArray findMethodUsingString(
...
static jlong load(JNIEnv *env, jobject thiz, jobject class_loader) {
    if (!class_loader)
        return 0;
...
static jlongArray findMethodInvoking(
...
static jlongArray findMethodInvoked(
        JNIEnv *env, jobject thiz, jlong method_index, jlong return_type,
        jshort parameter_count, jstring parameter_shorty, jlong declaring_class,
        jlongArray parameter_types, jlongArray contains_parameter_types,
        jintArray dex_priority, jboolean find_first) {
...
static jlongArray findMethodSettingField(
...
static jlongArray findMethodGettingField(
        JNIEnv *env, jobject thiz, jlong field_index, jlong return_type,
        jshort parameter_count, jstring parameter_shorty, jlong declaring_class,
        jlongArray parameter_types, jlongArray contains_parameter_types,
        jintArray dex_priority, jboolean find_first) {
...
static jlongArray findField(JNIEnv *env, jobject thiz,
...
static jobject decodeMethodIndex(JNIEnv *env, jobject thiz, jlong method_index) {
    auto *handler =
            reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
    if (!handler)
        return env->NewLongArray(0);
...
static jobject decodeFieldIndex(JNIEnv *env, jobject thiz, jlong field_index) {
    auto *handler =
            reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
    if (!handler)
        return env->NewLongArray(0);
...
static jlong encodeClassIndex(JNIEnv *env, jobject thiz, jclass clazz) {
    auto *handler =
            reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
    if (!handler)
        return -1;
...
static jlong encodeFieldIndex(JNIEnv *env, jobject thiz, jobject field) {
    auto *handler =
            reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
    if (!handler)
        return -1;
...
static jlong encodeMethodIndex(JNIEnv *env, jobject thiz, jobject method) {
    auto *handler =
            reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
    if (!handler)
        return -1;
...
static jclass decodeClassIndex(JNIEnv *env, jobject thiz, jlong class_index) {
    auto *handler =
            reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
    if (!handler)
        return nullptr;
...
static void closex(JNIEnv *env, jobject thiz) {
    auto *handler =
            reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
...
static void createFullCache(JNIEnv *env, jobject thiz) {
    auto *handler =
            reinterpret_cast<Handler *>(env->GetLongField(thiz, token_field));
    if (!handler)
        return;
...
jint JNI_OnLoad(JavaVM *vm, void *) {
    ...
    jclass helper = env->FindClass("io/github/vvb2060/callrecording/xposed/DexHelper");
    ...
    JNINativeMethod methods[] = {
            {"findMethodUsingString",  "(Ljava/lang/String;ZJSLjava/lang/String;J[J[J[IZ)[J", reinterpret_cast<void *>(findMethodUsingString)},
            {"findMethodInvoking",     "(JJSLjava/lang/String;J[J[J[IZ)[J",                   reinterpret_cast<void *>(findMethodInvoking)},
            {"findMethodInvoked",      "(JJSLjava/lang/String;J[J[J[IZ)[J",                   reinterpret_cast<void *>(findMethodInvoked)},
            {"findMethodSettingField", "(JJSLjava/lang/String;J[J[J[IZ)[J",                   reinterpret_cast<void *>(findMethodSettingField)},
            {"findMethodGettingField", "(JJSLjava/lang/String;J[J[J[IZ)[J",                   reinterpret_cast<void *>(findMethodGettingField)},
            {"findField",              "(J[IZ)[J",                                            reinterpret_cast<void *>(findField)},
            {"decodeClassIndex",       "(J)Ljava/lang/Class;",                                reinterpret_cast<void *>(decodeClassIndex)},
            {"decodeMethodIndex",      "(J)Ljava/lang/reflect/Member;",                       reinterpret_cast<void *>(decodeMethodIndex)},
            {"decodeFieldIndex",       "(J)Ljava/lang/reflect/Field;",                        reinterpret_cast<void *>(decodeFieldIndex)},
            {"encodeClassIndex",       "(Ljava/lang/Class;)J",                                reinterpret_cast<void *>(encodeClassIndex)},
            {"encodeMethodIndex",      "(Ljava/lang/reflect/Member;)J",                       reinterpret_cast<void *>(encodeMethodIndex)},
            {"encodeFieldIndex",       "(Ljava/lang/reflect/Field;)J",                        reinterpret_cast<void *>(encodeFieldIndex)},
            {"load",                   "(Ljava/lang/ClassLoader;)J",                          reinterpret_cast<void *>(load)},
            {"close",                  "()V",                                                 reinterpret_cast<void *>(closex)},
            {"createFullCache",        "()V",                                                 reinterpret_cast<void *>(createFullCache)},
    };

    if (env->RegisterNatives(helper, methods, sizeof(methods) / sizeof(methods[0])) < 0) {
        return JNI_ERR;
    }
